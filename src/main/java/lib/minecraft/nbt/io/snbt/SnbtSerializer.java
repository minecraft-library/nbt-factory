 ...
 *
 * <ul>
 *   <li><b>{@link lib.minecraft.nbt.tags.ByteTag ByteTag}</b> -
 *       numeric literal with a {@code b} suffix, e.g. {@code 34b}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.ShortTag ShortTag}</b> -
 *       numeric literal with an {@code s} suffix, e.g. {@code 31415s}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.IntTag IntTag}</b> -
 *       numeric literal with no suffix, e.g. {@code 31415926}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.LongTag LongTag}</b> -
 *       numeric literal with an {@code l} suffix, e.g. {@code 31415926l}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.FloatTag FloatTag}</b> -
 *       numeric literal with an {@code f} suffix, e.g. {@code 3.1415926f}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.DoubleTag DoubleTag}</b> -
 *       numeric literal with a {@code d} suffix, e.g. {@code 3.1415926d}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.ByteArrayTag ByteArrayTag}</b> -
 *       {@code [B;1b,2b,3b]}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.IntArrayTag IntArrayTag}</b> -
 *       {@code [I;1,2,3]}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.LongArrayTag LongArrayTag}</b> -
 *       {@code [L;1l,2l,3l]}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.ListTag ListTag}</b> -
 *       plain bracketed array {@code [value,value,...]}.</li>
 *   <li><b>{@link lib.minecraft.nbt.tags.CompoundTag CompoundTag}</b> -
